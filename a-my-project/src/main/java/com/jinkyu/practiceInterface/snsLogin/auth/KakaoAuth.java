...
public class KakaoAuth implements SnsAuth{
    ...
    public boolean login(String id, String pwd) {
        // 카카오 인증을 수행하여 id와 pwd가 일치하는지 확인합니다.
        return true;
    }

    @Override
    public boolean signUp(String id, String pwd) {
        // 카카오 인증을 통해 회원가입을 수행합니다.
        return true;
    }
    /*@Override
    public boolean login(MemberDTO member) {
        // Kakao 인증 로직 구현
        System.out.println("Kakao 인증을 시도합니다.");
    ...
    public boolean signUp(MemberDTO member) {
        // Kakao 회원 가입 로직 구현
        System.out.println("Kakao 회원 가입을 시도합니다.");
