...
public class Application02 {
    public static void main(String[] args) {
        ...
        * */
        ...
        // 논리 데이터 형은 0과 1의 값으로 데이터를 취급하기 떄문에 1bit로 표현이 가능하지만 최소단위가 1byte의 크기를 갖는다.
        ...
        *
        * 설명
        * 대입 연산자의 실행 방향은 오른쪽애서 왼쪽이다.
        * 즉 오른쪽에 있는 값을 왼쪽의 공간에 대입한다는 의미이며, 왼쪽에는 항상 공간, 오른쪽에는 항상 값이 온다.
        * 변수를 대입 연산자 왼쪽에 사용하면 공간의 의미이고, 대입 연산자 오른쪽에 사용하면 변수가 가진 값을 의미한다.
        * */
        ...
        char ch1 = 'a'; // 아스키 코드표를 참조하여 문자는 연산시 숫자로 변환된다.
