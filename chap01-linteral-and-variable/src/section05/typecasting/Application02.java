...
public class Application02 {
    public static void main(String[] args) {
        ...
        * */
        ...
        // 실수 간의 강제 형변환
        double dnum = 8.0;
        // float fnum = dnum; 이와 같이 형변환을 하지 않을 경우 컴파일러는 데이터 손실의 위험 때문에 에러를 발생시킨다. doubel > float
        ...
        char ch = 'a';
        //byte bnum2 = ch; // 자바에서 숫자를 취급하는 기본 자료형의 단위는 int이다. 이러한 이유로 char는 숫자로 변환시 반드시 int로 변경되기 때문에 다운 캐스팅 해줘야 한다.
        byte bnum2 = (byte)ch;
        ...
        /* 참고 boolean 타입의 경우 형변환 규칙에서 제외 되기 때문에 참고하자. */
