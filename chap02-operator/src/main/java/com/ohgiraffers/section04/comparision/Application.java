...
public class Application {
    public static void main(String[] args) {
        ...
        *
        * 비교 연산자의 종류
        * == : 왼쪽의 피연산자와 오른쪽의 피연산자가 같다면 true 다르다면 false를 반환한다.
        * != : 왼쪽의 피연산자와 오른쪽의 피연산자가 다르면 true 같다면 false를 반환한다.
        * > : 왼쪽의 피연산자와 오른쪽의 피연산자보다 크면 true 아니면 false를 반환
        * < : 왼쪽의 피연산자와 오른쪽의 피연산자보다 작으면 true 아니면 false를 반환
        * >= : 왼쪽의 피연산자와 오른쪽의 피연산자보다 크거나 같으면 true 작으면 false
        * <= : 왼쪽의 피연산자와 오른쪽의 피연산자보다 작거나 같으면 true 크면 false
        *
        * 참고: '!'은 앞으로 자주 사용하게될 친구로 값을 boolean의 결과값을 부정한다.
        * */
        ...
        System.out.println("inum1과 inum2가 같은지 비교 : "  );
        System.out.println(num1 == num2);
        System.out.println("inum1과 inum2가 같지 않은지 비교 : " );
        System.out.println(num1 != num2);
