...
public class Application6 {
    public static void main(String[] args) {
        ...
        * 복귀를 할 때는 그냥 복구 할 수도 있지만, 값을 가지고 복귀할 수도 있다.
        * 이 때 가지고 가는 값을 리턴값 이라고 한다.
        *
        * return 값을 반환 받기 위해서는 메소드 선언부에 리턴 타입을 명시해주어야 한다.
        * void는 아무 반환값도 가지지 않겠다는 리턴에 사용할 수 있는 키워드이다.
        ...
        * 메소드 작성 후 호출을 해보면 아무런 변화가 없으나 호출을 한 것이다.*/
        ...
        Application6 app2 = app6.appMethod();
