...
public class Application1 {
    public static void main(String[] args) {
        ...
        *   그렇기 때문에 서로 다른 패키지에 존재하는 클래스를 사용하는 경우에는 클래스명 앞에 패키지 명을 명시해서 풀 클래스 이름으로 사용해야 한다.
        * */

        main.java.com.ohgiraffers.section01.method.Calculator cal = new main.java.com.ohgiraffers.section01.method.Calculator();
        System.out.println(cal.minNumberOf(1, 3));
        System.out.println(main.java.com.ohgiraffers.section01.method.Calculator.maxNumberOf(1, 3));
    }
}
