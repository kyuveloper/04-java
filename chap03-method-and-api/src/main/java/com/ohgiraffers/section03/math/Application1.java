...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 모든 코드를 우리가 다 외울 수 없기 때문에 api 문서를 별도로 제공해주고 있다.
        * */
        ...
        * (객체의 상태를 관리하지 않고 기능만 제공하는 경우 메모리를 효율적으로 사용하기 위헤 자주 사용되는 기법이다.)
        * */

        System.out.println("-7의 절대값: " + (java.lang.Math.abs(-7))); // 풀어쓰면 이런뜻

        System.out.println("-1.25의 절대값: " + (Math.abs(-1.25))); // 자바에서 기본으로 제공하는 api라 import가 필요 없음
        ...
        Random random = new Random(); // Math와 겹쳐서 위에 import됨
