...
* brand 명과 price에 대한 속성을 중복 정의하지 않기 위해 부모가 가진 기능을 상속받았다.
* <이점> 1. 이를 통해 중복 코드가 줄어드는 이점이 생겼다.
* */
public class ElectricCar extends Car{
    // brand랑 price가 있으니까 정의를 다시 할 필요가 없다.
    private String carName;
    private String energy;

    public ElectricCar(String brand, int price, String carName, String energy) { // 부모에 기본 생성자가 없기 떄문에
        super(brand, price);
