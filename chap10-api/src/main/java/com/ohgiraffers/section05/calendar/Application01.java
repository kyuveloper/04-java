...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 1. Calendar 인스턴스는 불변객체가 아니기 때문에 값을 수정할 수 없다.
        * 2. 윤초 (leep second)를 고려하지 않는다.
        *   윤초란?
        *   형정 세계시에서 사용하는 세슘 원자 시계와 실제 지구의 자전/공전 속도를 기준으로 항 태양시의 차이로 인해
        ...
        * */
        ...
        /* getTime()은 1978년 1월 0시 0분 0초 이후 지난 시간을, milsecond로 계산하여 long 타입으로 반환한다.*/
        System.out.println(today.getTime());

        Date time = new Date(1698815816659L);
